...
apply_patch device/virt/virt-common 0011-virt-common-prop-service.patch
...
apply_patch system/sepolicy 0010-sepolicy-allow-prop-service-property-area.patch
