...
| Display | VirtIO GPU; optional 1280 x 2856 at 495 DPI logical profile; Mesa llvmpipe/lavapipe reports `ARM` / `Mali-G715` by default | Functional; public GPU name aligned, but no LTPO panel or phone GPU implementation |
